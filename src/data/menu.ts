...
export const MENU_CATEGORY_DEFAULTS: MenuCategoryDef[] = [
  ...
  { name: "Raw Items", image: "/menu/raw-items.jpg", icon: "package", notForSale: true },
  ...KHAANZ_CATEGORIES,
];
...
const menuItemsRaw: MenuItemInput[] = [
  ...
  },
  {
    ...
    isVeg: false,
    available: false,
    variations: [{ id: "momo", name: "Piece", price: 0 }],
  },

  // Raw Items (internal prep — not sold directly)
  {
    id: "indian-gravy",
    name: "Indian Gravy",
    category: "Raw Items",
    isVeg: true,
    available: false,
    variations: [{ id: "indian-gravy", name: "Batch", price: 0 }],
  },
  {
    id: "semi-fried-boneless-chicken",
    name: "Semi Fried Boneless Chicken",
    category: "Raw Items",
    isVeg: false,
    available: false,
    variations: [{ id: "semi-fried-boneless-chicken", name: "Batch", price: 0 }],
  },
  {
    id: "chicken-roll-masala",
    name: "Chicken Roll Masala",
    category: "Raw Items",
    isVeg: false,
    available: false,
    variations: [{ id: "chicken-roll-masala", name: "Batch", price: 0 }],
  },
  {
    id: "red-chutni",
    name: "Red Chutni",
    ...
    isVeg: true,
    available: false,
    variations: [{ id: "red-chutni", name: "Batch", price: 0 }],
  },
  {
    id: "fish-fry-masala",
  ...
  },
  {
    ...
    isVeg: false,
    available: false,
    variations: [{ id: "peri-peri-marinade", name: "Batch", price: 0 }],
  },
  {
    id: "peri-peri-strips",
    ...
    isVeg: false,
    available: false,
    variations: [{ id: "peri-peri-strips", name: "Batch", price: 0 }],
  },
  {
    ...
    isVeg: false,
    available: false,
    variations: [{ id: "peri-peri-popcorn", name: "Batch", price: 0 }],
  },
  {
    ...
    isVeg: false,
    available: false,
    variations: [{ id: "peri-peri-crispy-chicken", name: "Batch", price: 0 }],
  },
  {
    id: "peri-peri-wings",
    ...
    isVeg: false,
    available: false,
    variations: [{ id: "peri-peri-wings", name: "Batch", price: 0 }],
  },
  {
    ...
    isVeg: false,
    available: false,
    variations: [{ id: "peri-peri-burger-slices", name: "Batch", price: 0 }],
  },
  {
    id: "chole-masala",
    name: "Chole Masala",
    ...
    isVeg: true,
    available: false,
    variations: [{ id: "chole-masala", name: "Batch", price: 0 }],
  },
  {
    id: "pizza-dough",
    name: "Pizza Dough",
    ...
    isVeg: true,
    available: false,
    variations: [{ id: "pizza-dough", name: "Batch", price: 0 }],
  },
  {
    id: "naan-dough",
    name: "Naan Dough",
    ...
    isVeg: true,
    available: false,
    variations: [{ id: "naan-dough", name: "Batch", price: 0 }],
  },
  {
    id: "roll-dough",
    name: "Roll Dough",
    ...
    isVeg: false,
    available: false,
    variations: [{ id: "roll-dough", name: "Batch", price: 0 }],
  },
  {
    id: "dum-chicken",
    name: "Dum Chicken",
    ...
    isVeg: false,
    available: false,
    variations: [{ id: "dum-chicken", name: "Batch", price: 0 }],
  },
  {
    id: "boiled-chicken",
    name: "Boiled Chicken",
    ...
    isVeg: false,
    available: false,
    variations: [{ id: "boiled-chicken", name: "Batch", price: 0 }],
  },
  {
    id: "raw-aloo-parath-mix",
    name: "Raw Aloo Parath Mix",
    category: "Raw Items",
    isVeg: true,
    available: false,
    variations: [{ id: "raw-aloo-parath-mix", name: "Batch", price: 0 }],
  },
  {
    id: "raita",
    name: "Raita",
    ...
    isVeg: true,
    available: false,
    variations: [{ id: "raita", name: "Batch", price: 0 }],
  },
  {
    id: "raw-chicken-parath-mix",
  ...
  // Chole Poori/Bhature
  {
    id: "chole",
    name: "Chole",
    category: "Chole Poori/Bhature",
    isVeg: true,
    available: false,
    image: "/menu/chole.jpg",
    variations: [{ id: "chole", name: "Single", price: 20 }],
  },
  {
    id: "poori",
    name: "Poori",
    ...
    variations: [{ id: "poori", name: "Single", price: 10 }],
  },
  {
    id: "bhature",
    name: "Bhature",
    category: "Chole Poori/Bhature",
    isVeg: true,
    image: "/menu/bhature.jpg",
    variations: [{ id: "bhature", name: "Single", price: 15 }],
  },
  {
    id: "chole-poori",
    name: "Chole Poori",
    category: "Chole Poori/Bhature",
    isVeg: true,
    image: "/menu/chole-poori.jpg",
    variations: [{ id: "chole-poori", name: "Regular", price: 60 }],
  },
  {
    id: "chole-bhature",
    name: "Chole Bhature",
    ...
    isVeg: true,
    image: "/menu/chole-bhature.jpg",
    variations: [{ id: "chole-bhature", name: "Regular", price: 80 }],
  },
  {
    id: "chole-paratha",
    name: "Chole Paratha",
    category: "Chole Poori/Bhature",
    isVeg: true,
    image: "/menu/chole-paratha.jpg",
    variations: [{ id: "chole-paratha", name: "Regular", price: 100 }],
  },
