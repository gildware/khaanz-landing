...
export function permissionForAdminPagePath(
  ...
  const rules: { prefix: string; permission: AdminPermission }[] = [
    ...
    { prefix: "/admin/previous-sales", permission: "reports" },
    ...
    { prefix: "/admin/recipes", permission: "inventory" },
    ...
    { prefix: "/admin/menu-board", permission: "menu" },
...
export const ADMIN_NAV_PERMISSION: Record<string, AdminPermission> = {
  ...
  "/admin/previous-sales": "reports",
  "/admin/cash": "reports",
  "/admin/online-orders": "online_orders",
  "/admin/orders": "orders",
  "/admin/inventory": "inventory",
  "/admin/recipes": "inventory",
