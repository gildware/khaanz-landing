/**
 * Add Butter Chicken half + full recipes (kitchen recipe sheet).
 * Run: npx tsx scripts/add-butter-chicken-recipe.ts
 */
import { getPrisma } from "../src/lib/prisma";

const MENU_ITEM_ID = "butter-chicken";
...
const RECIPES = [
  { variationId: "butter-chicken-half", label: "Butter Chicken — Half", lines: HALF_LINES },
  { variationId: "butter-chicken-full", label: "Butter Chicken — Full", lines: FULL_LINES },
] as const;
