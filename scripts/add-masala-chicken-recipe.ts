/**
 * Add Masala Chicken half + full recipes (kitchen recipe sheet).
 * Run: npx tsx scripts/add-masala-chicken-recipe.ts
 */
import { getPrisma } from "../src/lib/prisma";

const MENU_ITEM_ID = "masala-chicken";
...
const HALF_LINES: RecipeLine[] = [
  ...
  { inventoryItemId: "cmrnf5c1g006spm0i0gufi4tl", qtyBase: 6, note: "Capsicum" },
  {
...
const FULL_LINES: RecipeLine[] = [
  ...
  { inventoryItemId: "cmrnf5c1g006spm0i0gufi4tl", qtyBase: 9, note: "Capsicum" },
  {
    componentMenuItemId: INDIAN_GRAVY_ID,
    componentVariationId: INDIAN_GRAVY_ID,
    qtyBase: 450,
...
const RECIPES = [
  { variationId: "masala-chicken-half", label: "Masala Chicken — Half", lines: HALF_LINES },
  { variationId: "masala-chicken-full", label: "Masala Chicken — Full", lines: FULL_LINES },
] as const;
