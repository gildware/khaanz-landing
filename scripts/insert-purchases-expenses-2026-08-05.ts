/**
 * Insert notebook purchases and expenses for 2026-08-05.
 * Does not insert sales or cashbook. Faisal leave already marked.
 *
 * Run: npx tsx scripts/insert-purchases-expenses-2026-08-05.ts
 */
import { Prisma, PrismaClient } from "@prisma/client";

import { createPurchaseInTransaction } from "../src/lib/inventory/purchase-flow";

const OCCURRED_AT = new Date("2026-08-05T12:00:00+05:30");
const OTHER_NOTE = "Handwritten notebook 5/8 — cash purchases";
const TARIQ_NOTE = "Handwritten notebook 5/8 — Tariq Chicken M-pay";
...
const OTHER_LINES: PurchaseSpec[] = [
  { itemName: "Mixed Vegetable", qty: "1", totalRupees: 350 },
  { itemName: "Milk", qty: "3", totalRupees: 150 },
  { itemName: "Cabbage", qty: "17", totalRupees: 595 },
  { itemName: "Capsicum", qty: "1", totalRupees: 50 },
  { itemName: "Lemon", qty: "0.5", totalRupees: 80 },
  { itemName: "Tomato", qty: "5", totalRupees: 250 },
  { itemName: "Green Chilli", qty: "1", totalRupees: 80 },
  { itemName: "Cabbage", qty: "1", totalRupees: 100 },
  { itemName: "Ghee", qty: "2", totalRupees: 320 },
  { itemName: "Egg", qty: "30", totalRupees: 200 },
  { itemName: "Tea Glasses", qty: "12", totalRupees: 60 },
  { itemName: "Tissue", qty: "20", totalRupees: 200 },
  { itemName: "Food Grade Bags", qty: "2", totalRupees: 360 },
];

const TARIQ_LINES: PurchaseSpec[] = [
  { itemName: "Full Live chicken", qty: "16", totalRupees: 2700 },
];

const EXPENSES = [
  { categoryName: "Staff Food", note: "Roti", amountRupees: 150 },
  { categoryName: "Staff Food", note: "Veg", amountRupees: 100 },
  { categoryName: "Welding", note: "Mistri welding", amountRupees: 800 },
  { categoryName: "Parking", note: "Parking", amountRupees: 70 },
] as const;
  ...
  try {
    ...
    const result = await prisma.$transaction(
      async (tx) => {
        ...
        const bags = await tx.inventoryItem.findFirst({
          where: { name: "Food Grade Bags", active: true },
        });
        if (!bags) {
        ...
        for (const name of ["Welding", "Parking"]) {
        ...
        return { otherPurchase, tariqPurchase, expenseRows };
      },
      { timeout: 90_000 },
    );
      ...
      JSON.stringify(
        {
          ...
          skipped: [
            "sales (POS already has 5 Aug)",
            "cashbook",
            "pizza 350 free",
            "sabzi lump 1200 (used veg list)",
